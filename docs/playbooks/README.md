...
These playbooks turn [`OPERATING.md`](../../OPERATING.md) into repeatable actions.

| Playbook | Use it when |
| --- | --- |
| [Lead response](lead-response.md) | A new contact, call, text, or booking arrives |
| [AI-question conversation](ai-question-conversation.md) | Preparing for and delivering the free exploratory conversation |
